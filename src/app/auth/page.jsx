    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
            <div className="p-8 bg-white border rounded-lg shadow-md max-w-sm w-full text-center">
                ...
                {session ? (
                    <div>
                        <p className="mb-4 text-gray-700">Signed in as {session.user.email}</p>
                        <button
                            onClick={() => signOut()}
                    ...
                    <div>
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700 w-full flex items-center justify-center gap-2"
                        >
